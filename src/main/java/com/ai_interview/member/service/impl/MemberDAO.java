...
public class MemberDAO extends EgovAbstractDAO {
	...
	public MemberVO getMember(String userid) {
		return (MemberVO) select("memberDAO.getMember", userid);
	}
...
//	 * @exception Exception
//	 */
//	public String insertSample(MemberVO vo) throws Exception {
...
//		return (MemberVO) select("sampleDAO.selectSample", vo);
//	}
//
