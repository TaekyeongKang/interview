...
<div class="sidebar">
	...
	<div class="user-panel mt-3 pb-3 mb-3 d-flex">
		<div class="image">
			<img src="${cp }/member/profileImgView?userid=${S_MEMBER.userid}"  class="img-circle elevation-2"
				alt="User Image">
		</div>
		<div class="info">
			<div class="row">
				<a class="col-md-8" href="#" class="d-block">${S_MEMBER.userid }(${S_MEMBER.alias })</a>
			</div>
		</div>
	</div>
